...
import { featureCards, navItems, productCards, stats } from "@/features/home/home.constants";
import { ArrowRight, BadgeDollarSign, CircleUserRound, Wallet } from "lucide-react";
    ...
    <main className="min-h-screen bg-[#f5f7f5] text-ink">
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-5 pb-16 sm:px-8 lg:grid-cols-4">
        {featureCards.map(({ title, copy, icon: Icon }) => (
          <article
            className="rounded-lg border border-line bg-white p-6 transition hover:-translate-y-1 hover:border-hnb hover:shadow-soft"
            key={title}
          >
